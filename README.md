...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `344.0µs` | `272.3µs` |
| [Day 2](./src/bin/02.rs) | `61.2µs` | `78.6µs` |
| [Day 3](./src/bin/03.rs) | `162.2µs` | `220.5µs` |
| [Day 4](./src/bin/04.rs) | `210.1µs` | `208.5µs` |
| [Day 5](./src/bin/05.rs) | `17.5µs` | `40.1µs` |
