...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `35.1µs` | `257.6µs` |
| [Day 2](./src/bin/02.rs) | `60.9µs` | `72.7µs` |
| [Day 3](./src/bin/03.rs) | `195.2µs` | `205.7µs` |
| [Day 4](./src/bin/04.rs) | `211.4µs` | `197.2µs` |
| [Day 5](./src/bin/05.rs) | `20.2µs` | `39.2µs` |
| [Day 6](./src/bin/06.rs) | `128.0ns` | `521.0ns` |
| [Day 7](./src/bin/07.rs) | `268.1µs` | `250.3µs` |
| [Day 8](./src/bin/08.rs) | `224.1µs` | `1.8ms` |
| [Day 9](./src/bin/09.rs) | `119.5µs` | `113.6µs` |
| [Day 10](./src/bin/10.rs) | `924.3µs` | `1.9ms` |
| [Day 11](./src/bin/11.rs) | `211.5µs` | `199.6µs` |
| [Day 12](./src/bin/12.rs) | `572.9µs` | `4.1ms` |
| [Day 13](./src/bin/13.rs) | `150.8µs` | `1.3ms` |
| [Day 14](./src/bin/14.rs) | `28.0µs` | `26.1ms` |
| [Day 15](./src/bin/15.rs) | `44.8µs` | `144.0µs` |
